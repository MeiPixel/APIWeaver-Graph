...
from tools.search import search_data,question_rag
...
def write_code(question):
    prompt = f'''
Possible useful function documentation:
---doc---
...
with open('answer9.json', encoding='utf8') as f:
...
def main():
    with ThreadPoolExecutor(max_workers=5) as executor:
        ...
        for future in as_completed(future_to_item):
            item = future.result()
            if item is not None:
                with open('answer9.json', 'a', encoding='utf8') as f:
